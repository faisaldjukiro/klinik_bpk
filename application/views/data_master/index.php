                    ...
                    <div class="card overflow-auto">
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($supplier as $sm) : ?>
                                    <tr>
                                        <th scope="row"><?= $no++ ?></th>
                                        <td><?= $sm['nama_supplier']; ?></td>
                                        <td><?= $sm['no_telp']; ?></td>
                                        <td><?= $sm['alamat_suplier']; ?></td>
                                        <td>
                                            <a type="button"
                                                href="<?= base_url('master/supplier-edit/') . $sm['id_supplier']; ?>"
                                                class="badge bg-primary"><i class="bi bi-pencil"></i></a>

                                            <a type="button" class="badge bg-danger"
                                                data-bs-target="#hapus<?= $sm['id_supplier']; ?>"

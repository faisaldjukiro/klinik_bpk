    ...
    <main>
        <div class="container">
            ...
            <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
                <h1>404</h1>
                <h2>Anda Tidak Memiliki Akses Di Sini</h2>
                <a class="btn" href="<?= base_url('beranda')?>">Beranda</a>
                <img src=" <?= base_url('template/')?>assets/img/not-found.svg" class="img-fluid py-5"
                    alt="Page Not Found">
                <div class="credits">

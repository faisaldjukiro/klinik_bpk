...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('pegawai/tambah') ?>" method="post">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kd_peg" readonly id="kd_peg" value="<?= $kode_peg ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" value="<?= set_value('nama_lengkap') ?>"> <small class=" text-danger"><?= form_error('nama_lengkap'); ?></small>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="id_subbagian" id="subbagian" style="width: 100%">
                                            <option value=""></option>
                                            <?php foreach ($subbgaian as $m) : ?>
                                                <option value="<?= $m['id_subbagian']; ?>"><?= $m['nama_subbagian']; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="id_staf" id="staf" style="width: 100%">
                                            ...
                                            <?php foreach ($staf as $m) : ?>
                                                <option value="<?= $m['id_staf']; ?>"><?= $m['nama_staf']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" value="<?= set_value('tgl_lahir') ?>"> <small class=" text-danger"><?= form_error('tgl_lahir'); ?></small>
                                    </div>
                                </div>
    ...
    <script>
        // Contoh pengaturan nilai tanggal menggunakan JavaScript
        var nilaiTanggalJS = new Date().toISOString().split('T')[0];
        document.getElementById('tgl_lahir').value = nilaiTanggalJS;
    </script>
